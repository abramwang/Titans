...
public:
    ...
    /**
     * @brief                       接收商业港股港股通成交额快照数据回调
     *
     * @param snaps                 商业港股港股通成交额快照数据
     * @param cnt                   商业港股港股通成交额快照数据条数
     */
    virtual void OnMDHKExConnectTurnoverSnapshot(MDHKExConnectTurnoverSnapshot* snaps, uint32_t cnt);
