...
public:
     ...
     * @brief                       经纪最优报价行情数据回调
     *  
     * @param snaps                 经纪最优报价行情数据
     * @param cnt                   经纪最优报价行情数据条数
     */
    virtual void OnMDBrokerBestOfferSnapshot(MDBrokerBestOfferSnapshot* snaps, uint32_t cnt) ;

    /**
     * @brief                       经纪成交行情数据回调
     *  
     * @param snaps                 经纪成交行情数据
     * @param cnt                   经纪成交行情数据条数
     */
    virtual void OnMDBrokerTickExecution(MDBrokerTickExecution* ticks, uint32_t cnt) ;
}; // end of CFETSSpi
