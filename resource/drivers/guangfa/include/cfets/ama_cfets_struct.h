...
/*
精度说明:
本文中所有字段带有类型说明的相比如实际值有扩大倍数,详细倍数扩大规则可参考ama_struct.h
*/
...
struct MDSpotTickExecution
{
   ...
   int64_t  exec_price;                                                      // 净价(单位:元;类型:Price6)
   int64_t  exec_yield;                                                      // 收益率(单位:%;类型:Rate6)
   int64_t  total_face_value;                                                // 券面总额(单位:元;类型:Amt5)
...
struct MDSpotSummarySnapshot
{
    ...
    int64_t  pre_close_clean_price;                                          // 前收盘净价(类型:Price6)
    int64_t  pre_weighted_avg_clean_price;                                   // 前加权平均净价(类型:Price6)
    int64_t  open_clean_price;                                               // 开盘净价(类型:Price6)
    int64_t  last_clean_price;                                               // 最新净价(类型:Price6)
    int64_t  ratio_of_change;                                                // 涨跌幅(类型:Rate6)
    int64_t  high_clean_price;                                               // 最高净价(类型:Price6)
    int64_t  low_clean_price;                                                // 最低净价(类型:Price6)
    int64_t  close_clean_price;                                              // 收盘净价(类型:Price6)
    int64_t  weighted_avg_clean_price;                                       // 加权平均净价(类型:Price6)
    int64_t  pre_close_yield;                                                // 前收盘收益率(类型:Rate6)
    int64_t  pre_weighted_avg_yield;                                         // 前加权平均收益率(类型:Rate6)
    int64_t  open_yield;                                                     // 开盘收益率(类型:Rate6)
    int64_t  last_yield;                                                     // 最新收益率(类型:Rate6)
    int64_t  high_yield;                                                     // 最高收益率(类型:Rate6)
    int64_t  low_yield;                                                      // 最低收益率(类型:Rate6)
    int64_t  close_yield;                                                    // 收盘收益率(类型:Rate6)
    int64_t  weighted_avg_yield;                                             // 加权平均收益率(类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:百万;类型:Qty4)
    int64_t  num_trades;                                                     // 成交笔数(类型:Qty4)
    int64_t  change_over_net_price;                                          // 净价涨跌(类型:Rate6)
    int64_t  change_over_yields;                                             // 收益率涨跌(类型:Rate6)
    int64_t  term_to_maturity;                                               // 年化待偿期(类型:Rate6)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDSpotXBondSnapshot
{
    ...
    int64_t  last_clean_price;                                               // 最新成交净价(单位:元;类型:Price6)
    int64_t  last_yield;                                                     // 最新成交到期收益率(单位:%;类型:Rate6)
    int64_t  high_clean_price;                                               // 最高成交净价(单位:元;类型:Price6)
    int64_t  high_yield;                                                     // 最高成交到期收益率(单位:%;类型:Rate6)
    int64_t  low_clean_price;                                                // 最低成交净价(单位:元;类型:Price6)
    int64_t  low_yield;                                                      // 最低成交到期收益率(单位:%;类型:Rate6)
    int64_t  open_clean_price;                                               // 开盘价(单位:元;类型:Price6)
    int64_t  open_yield;                                                     // 开盘到期收益率(类型:Rate6)
    int64_t  pre_open_clean_price;                                           // 前开盘净价(类型:Price6)
    int64_t  pre_open_yield;                                                 // 前开盘到期收益率(类型:Rate6)
    int64_t  weighted_avg_clean_price;                                       // 加权平均净价(类型:Price6)
    int64_t  weighted_avg_yield;                                             // 加权平均到期收益率(类型:Rate6)
    int64_t  pre_weighted_avg_clean_price;                                   // 前加权平均净价(类型:Price6)
    int64_t  pre_weighted_avg_yield;                                         // 前加权平均到期收益率(类型:Rate6)
    int64_t  pre_close_clean_price;                                          // 前收盘净价(类型:Price6)
    int64_t  pre_close_yield;                                                // 前收盘到期收益率(类型:Rate6)
    int64_t  ratio_of_change;                                                // 净价涨跌幅(类型:Rate6)
    int64_t  change_over_yields;                                             // 收益率涨跌(类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:元;类型:Qty4)
...
struct MDPledgeRepoTickExecution
{
    ...
    char     deal_number[ConstField::kExecIDLen];                            // 成交编号
    char     exec_type[ConstField::kExecTypeLen];                            // 成交类型(枚举值:F-成交 4-撤销 5-更新)
    int64_t  exec_price;                                                     // 回购利率(单位:%;类型:Rate6)
    int64_t  exec_amount;                                                    // 交易金额(单位:元(四舍五入);类型:Amt5)
...
struct MDPledgeRepoSummarySnapshot
{
    ...
    int32_t  md_sub_type;                                                    // 市场行情子类别(0-成交行情)
    int64_t  avg_term;                                                       // 平均回购期限(单位:天;类型:Qty4)
    int64_t  last_price;                                                     // 最新利率(单位:%;类型:Rate6)
    int64_t  open_price;                                                     // 开盘利率(单位:%;类型:Rate6)
    int64_t  high_price;                                                     // 最高利率(单位:%;类型:Rate6)
    int64_t  low_price;                                                      // 最低利率(单位:%;类型:Rate6)
    int64_t  weighted_avg_price;                                             // 加权平均利率(单位:%;类型:Rate6)
    int64_t  bond_weighted_avg_price;                                        // 加权平均利率(利率债)(单位:%;类型:Rate6)
    int64_t  pre_weighted_avg_price;                                         // 前加权平均利率(单位:%;类型:Rate6)
    int64_t  close_price;                                                    // 收盘利率(单位:%;类型:Rate6)
    int64_t  pre_close_price;                                                // 前收盘利率(单位:%;类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:元;类型:Qty4)
    int64_t  num_trades;                                                     // 成交笔数(类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
...
struct MDPledgeRepoInquirySnapshot
{
    ...
    int64_t  pre_close_price;                                                // 前收盘利率(单位:%;类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:元;类型:Qty4)
    int64_t  num_trades;                                                     // 成交笔数(单位:笔;类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDPledgeRepoDepositSnapshot
{
    ...
    int64_t  close_price;                                                    // 收盘利率(单位:%;类型:Rate6)
    int64_t  pre_close_price;                                                // 前收盘利率(单位:%;类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:亿元;类型:Qty4)
    int64_t  num_trades;                                                     // 成交笔数(类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDCeditLoanTickExecution
{
    ...
    int64_t  exec_price;                                                     // 拆借利率(类型:Rate6)
    int64_t  exec_amount;                                                    // 拆借金额(类型:Amt5)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDCeditLoanSnapshot
{
    ...
    char     md_type;                                                        // 市场行情类型(R-表示本币市场)
    int32_t  md_sub_type;                                                    // 市场行情子类别(7-代表交易品种行情)
    int64_t  avg_term;                                                       // 平均拆借期限(单位:天;类型:Qty4)
    int64_t  last_price;                                                     // 最新利率(单位:%;类型:Rate6)
    int64_t  open_price;                                                     // 开盘利率(单位:%;类型:Rate6)
    int64_t  high_price;                                                     // 最高利率(单位:%;类型:Rate6)
    int64_t  low_price;                                                      // 最低利率(单位:%;类型:Rate6)
...
struct MDSwapFixedFloatTickExecution
{
    ...
    int64_t  price;                                                          // 名义本金金额(类型:Amt5)
    int64_t  fixed_rate;                                                     // 固定利率(类型:Rate6)
    char     benchmark_curve_name[ConstField::kBenchmarkCurveNameLen];       // 参考利率曲线名称
    int64_t  interest_rate_spread;                                           // 利差(类型:Rate6)
...
struct MDSwapFixedFloatSnapshot
{
    ...
    char     benchmark_curve_name[ConstField::kBenchmarkCurveNameLen];       // 参考利率曲线名称
    char     trade_limit_days[ConstField::kTradeLimitDaysLen];               // 交易期限
    int64_t  last_price;                                                     // 最新固定利率(单位:%;类型:Rate6)
    int64_t  open_price;                                                     // 开盘固定利率(单位:%;类型:Rate6)
    int64_t  high_price;                                                     // 最高固定利率(单位:%;类型:Rate6)
    int64_t  low_price;                                                      // 最低固定利率(单位:%;类型:Rate6)
    int64_t  weighted_avg_price;                                             // 加权平均固定利率(单位:%;类型:Rate6)
    int64_t  pre_weighted_avg_price;                                         // 前加权平均固定利率(单位:%;类型:Rate6)
    int64_t  close_price;                                                    // 收盘固定利率(单位:%;类型:Rate6)
    int64_t  pre_close_price;                                                // 前收盘固定利率(单位:%;类型:Rate6)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:百万元;类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDSwapXSwapSnapshot
{
    ...
    char     md_type;                                                        // 市场行情类型(R-本币市场行情)
    int32_t  md_sub_type;                                                    // 市场行情子类别(0-成交行情)
    int64_t  last_price;                                                     // 最新利率(单位:直接合约为% 期差合约为bp;类型:Rate6)
    int64_t  open_price;                                                     // 开盘利率(单位:直接合约为% 期差合约为bp;类型:Rate6)
    int64_t  high_price;                                                     // 最高利率(单位:直接合约为% 期差合约为bp;类型:Rate6)
    int64_t  low_price;                                                      // 最低利率(单位:直接合约为% 期差合约为bp;类型:Rate6)
    int64_t  ref_price;                                                      // 盘中参考价(单位:直接合约为% 期差合约为bp;类型:Price6)
    int64_t  volume_trade;                                                   // 最新成交量(单位:元;类型:Qty4)
    int64_t  total_volume_trade;                                             // 当日累计成交量(单位:元;类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDSwapXSwapBestOfferSnapshot
{
    ...
    int64_t  bid_price;                                                      // 报买价(单位:直接合约为% 期差合约为bp;类型:Price6)
    int64_t  bid_volume;                                                     // 报买量(单位:元;类型:Qty4)
    int64_t  offer_price;                                                    // 报卖价(单位:直接合约为% 期差合约为bp;类型:Price6)
    int64_t  offer_volume;                                                   // 报卖量(单位:元;类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDBondLoanTickExecution
{
    ...
    int64_t  underlying_qty;                                                    // 标的债券券面总额(类型:Amt5)
    uint8_t  variety_category;                                                  // 品种类别
};
/**  @} */
...
struct MDBondLoanUnderlyingSecurityRateSnapshot
{
    ...
    int64_t  last_price;                                                        // 最新费率(单位:%;类型:Rate6)
    int64_t  open_price;                                                        // 开盘费率(单位:%;类型:Rate6)
    int64_t  high_price;                                                        // 最高费率(单位:%;类型:Rate6)
    int64_t  low_price;                                                         // 最低费率(单位:%;类型:Rate6)
    int64_t  weighted_avg_price;                                                // 加权平均费率(单位:%;类型:Rate6)
    int64_t  pre_weighted_avg_price;                                            // 前加权平均费率(单位:%;类型:Rate6)
    int64_t  close_price;                                                       // 收盘费率(单位:%;类型:Rate6)
    int64_t  pre_close_price;                                                   // 前收盘费率(单位:%;类型:Rate6)
    int64_t  total_volume_trade;                                                // 当日累计成交量(单位:百万元;类型:Qty4)
    uint8_t  variety_category;                                                  // 品种类别
};
/**  @} */
...
struct MarketMakersQuoteItem
{
    ...
    int64_t  trading_time;                                                   // 业务发生时间(YYYYMMDDHHMMSSsss)
    int64_t  clean_price;                                                    // 净价(类型:Price6)
    int64_t  maturity_yield;                                                 // 到期收益率(类型:Rate6)
    int64_t  dirty_price;                                                    // 全价(类型:Price6)
    int64_t  total_face_value;                                               // 全面总额(类型:Amt5)
    ...
    int64_t  settl_curr_fx_rate;                                             // 汇率(类型:Rate6)
...
struct MDSpotXBondDepthQuoteSnapshot
{
    ...
    char     md_req_id[ConstField::kExecIDLen];                              // 订阅请求ID(客户参考编号)
    char     settl_type[ConstField::kSettlTypeLen];                          // 清算速度(1-T+0 2-T+1)
    int64_t  bid_clean_price[ConstField::kPositionLevel6];                   // 报买净价(单位:元;类型:Price6)
    int64_t  bid_volume[ConstField::kPositionLevel6];                        // 报买量(单位:元;类型:Qty4)
    int64_t  bid_yield[ConstField::kPositionLevel6];                         // 报买到期收益率(单位:%;类型:Rate6)
    int64_t  offer_clean_price[ConstField::kPositionLevel6];                 // 报卖净价(单位:元;类型:Price6)
    int64_t  offer_volume[ConstField::kPositionLevel6];                      // 报卖量(单位:元;类型:Qty4)
    int64_t  offer_yield[ConstField::kPositionLevel6];                       // 报卖到期收益率(单位:%;类型:Rate6)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDSpotXBondMatchQuoteSnapshot
{
    ...
    char     md_req_id[ConstField::kExecIDLen];                              // 订阅请求ID(客户参考编号)
    char     settl_type[ConstField::kSettlTypeLen];                          // 清算速度(1-T+0 2-T+1)
    int64_t  bid_volume;                                                     // 买入未匹配量(单位:元;类型:Qty4)
    int64_t  offer_volume;                                                   // 卖出未匹配量(单位:元;类型:Qty4)
    int64_t  total_available_volume;                                         // 可成交总量(单位:元;类型:Qty4)
    int64_t  open_clean_price;                                               // 开盘净价(单位:元;类型:Price6))
    int64_t  open_yield;                                                     // 开盘到期收益率(单位:%;类型:Rate6)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDPledgeRepoXRepoDepthQuoteSnapshot
{
    ...
    char     md_req_id[ConstField::kExecIDLen];                              // 订阅请求ID(客户参考编号)
    int64_t  bid_price[ConstField::kPositionLevel6];                         // 逆回购利率(单位:%;类型:Rate6)
    int64_t  bid_volume[ConstField::kPositionLevel6];                        // 逆回购可成交量(单位:元;类型:Qty4)
    int64_t  bid_trade_volume[ConstField::kPositionLevel6];                  // 逆回购量(单位:元;类型:Qty4)
    int64_t  offer_price[ConstField::kPositionLevel6];                       // 正回购利率(单位:%;类型:Rate6)
    int64_t  offer_volume[ConstField::kPositionLevel6];                      // 正回购可成交量(单位:元;类型:Qty4)
    int64_t  offer_trade_volume[ConstField::kPositionLevel6];                // 正回购量(单位:元;类型:Qty4)  
...
struct MDPledgeRepoXRepoBestOfferQuoteSnapshot
{
    ...
    char     match_type;                                                     // 回购方式 ("1"-双边回购  "3"-通用回购)
    char     md_req_id[ConstField::kExecIDLen];                              // 订阅请求ID(客户参考编号)
    int64_t  bid_price;                                                      // 逆回购利率(单位:%;类型:Rate6)
    int64_t  bid_trade_volume;                                               // 逆回购量(单位:元;类型:Qty4)
    int64_t  offer_price;                                                    // 正回购利率(单位:%;类型:Rate6)
    int64_t  offer_trade_volume;                                             // 正回购量(单位:元;类型:Qty4)  
    uint8_t  variety_category;                                               // 品种类别 
};
/**  @} */
...
struct MDSwapXSwapDepthQuoteSnapshot
{
    ...
    int64_t  bid_price[ConstField::kDireciveLevelLen];                       // 买价(单位:%;类型:Price6)
    int64_t  bid_volume[ConstField::kDireciveLevelLen];                      // 买单可成交量(单位:元;类型:Qty4)
    int64_t  bid_trade_volume[ConstField::kDireciveLevelLen];                // 买单总量(单位:元;类型:Qty4)
    int64_t  offer_price[ConstField::kDireciveLevelLen];                     // 卖价(单位:%;类型:Price6)
    int64_t  offer_volume[ConstField::kDireciveLevelLen];                    // 卖单可成交量(单位:元;类型:Qty4)
    int64_t  offer_trade_volume[ConstField::kDireciveLevelLen];              // 卖单总量(单位:元;类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */
...
struct MDSwapXSwapTickExecution
{
    ...
    int64_t  exec_price;                                                     // 价格(类型:Price6)
    int64_t  exec_volume;                                                    // 成交量(类型:Qty4)
    uint8_t  variety_category;                                               // 品种类别
};
/**  @} */

/**
 * @name MDBrokerBestOfferSnapshot 经纪最优报价行情数据结构
 * 字段类型的扩大倍数参考 华锐高速行情平台AMD转码API开发指南中的 "精度说明"
 * @{ 
 * */
struct MDBrokerBestOfferSnapshot
{
    uint8_t  market_type;                                                      // 市场类型
    char     msg_type[ConstField::kMsgTypeLen];                                // 报文类型
    int64_t  msg_seq_num;                                                      // 报文序号
    int64_t  sending_time;                                                     // 报文发送时间 (YYYYMMDDHHMMSSsss)
    char     security_code[ConstField::kCFETSSecurityCodeLen];                 // 证券代码
    int64_t  orig_time;                                                        // 业务发生时间(YYYYMMDDHHMMSSsss)
    char     symbol[ConstField::kSymbolLen];                                   // 证券简称
    int32_t  md_book_type;                                                     // 订阅行情类型（1-最优行情）
    int32_t  md_sub_book_type;                                                 // 订阅行情子类型 1173 MDSubBookType（126-经纪报价）
    char     term_to_maturity[ConstField::kTermToMaturityLen];                 // 待偿期
    int64_t  cfets_valuation_yield;                                            // CFETS 估值
    char     broker[ConstField::kBrokerLen];                                   // 经纪公司
    char     market_id[ConstField::kMarketIDLen];                              // 交易市场
    char     security_desc[ConstField::kSecurityDescLen];                      // 债券类型
    char     latest_subject_rating[ConstField::kLatestSubjectRatingLen];       // 评级
    int32_t  bid_price_type;                                                   // 报买价格类别
    int64_t  bid_price;                                                        // 报买价
    char     bid_volume[ConstField::kVolumeStringLen];                         // 报买量
    char     bid_yield_type[ConstField::kYieldTypeLen];                        // 报买收益率类型
    char     bid_text[ConstField::kTextLen];                                   // 报买备注
    int32_t  offer_price_type;                                                 // 报卖价格类别
    int64_t  offer_price;                                                      // 报卖价
    char     offer_volume[ConstField::kVolumeStringLen];                       // 报卖量
    char     offer_yield_type[ConstField::kYieldTypeLen];                      // 报卖收益率类型
    char     offer_text[ConstField::kTextLen];                                 // 报卖备注
    uint8_t  variety_category;                                                 // 品种类别
};
/**  @} */

/**
 * @name MDBrokerTickExecution 经纪成交行情数据结构
 * 字段类型的扩大倍数参考 华锐高速行情平台AMD转码API开发指南中的 "精度说明"
 * @{ 
 * */
struct MDBrokerTickExecution
{
    uint8_t  market_type;                                                      // 市场类型
    char     msg_type[ConstField::kMsgTypeLen];                                // 报文类型
    int64_t  msg_seq_num;                                                      // 报文序号
    ...
    char     transaction_method[ConstField::kTransactionMethodLen];            // 成交方向(取值：TKN, GVN, TRD)  
    char     exec_type[ConstField::kExecTypeLen];                              // 成交类型 (枚举值：F-成交、4-撤销、5-更新)
    char     deal_number[ConstField::kExecIDLen];                              // 成交编号
    int32_t  price_type;                                                       // 价格类别
    int64_t  exec_price;                                                       // 成交价
    char     exec_volume[ConstField::kVolumeStringLen];                        // 成交量
    char     settl_type[ConstField::kSettlTypeLen];                            // 清算速度(1-T+0 2-T+1)
    char     yield_type[ConstField::kYieldTypeLen];                            // 收益率类型
    int64_t  spread_px;                                                        // 涨跌(BP)
    char     text[ConstField::kTextLen];                                       // 备注
    uint8_t  variety_category;                                                 // 品种类别
};
/**  @} */
...
struct BondInfoConvertItem
{
    ...
    int64_t convert_ratio;                                                      // 转换比例(类型:Rate6)
    int64_t convert_price;                                                      // 转换价格(单位:元;类型:Price6)
};
...
struct BondInfoReissueItem
{
    ...
    int64_t reissue_volume;                                                     // 增发量(单位:亿;类型:Qty10)
};
...
struct BondInfoExerciseItem
{
    ...
    int64_t exercise_price;                                                     // 行权价格(单位:元;类型:Price6)
    int64_t exercise_volume;                                                    // 行权量(单位:亿;类型:Qty10)
    int64_t exercise_spread;                                                    // 行权后利率/基准利差(单位:%)(类型:Rate6)
};
...
struct MDBondInfoInterbank
{
    ...
    int64_t issue_size;                                                         // 发行量(单位:亿;类型:Qty10)
    int64_t issue_price;                                                        // 发行价格(单位:元;类型:Price6)
    int64_t face_value;                                                         // 面值(单位:元;类型:Amt5)
    int64_t issue_date;                                                         // 发行日(YYYYMMDD)
    int64_t circulation_volume;                                                 // 流通量(单位:亿;类型:Qty10)
    ...
    int64_t acrd_int_amt;                                                       // 每百元应计利息(类型:Rate15)
    ...
    int64_t fixed_rate;                                                         // 固定利率(单位:%)(类型:Rate6)
    char	base_rate_name[ConstField::kBenchmarkCurveNameLen];					// 基准利率名	                        
    int64_t	base_rate_value;                                                    // 基准利率值(单位:%)(类型:Rate6)      
    int64_t	base_rate_spread;                                                   // 基准利差(基点)(单位:%)(类型:Rate6)
    int64_t	interest_cap_rate;                                                  // 利率上限(类型:Rate6)              
    int64_t	interest_floor_rate;                                                // 利率下限(类型:Rate6)              
    int64_t	current_coupon_rate;                                                // 当前票面利率(类型:Rate6)          
...
struct MDABSInfo
{
    ...
    char    standard_compen_period[ConstField::kTermToMaturityStringLen];       // 标准待偿期	                     
    char    currency[ConstField::kCcyLen];                                      // 币种(CNY:人民币 USD:美元)                      
    int64_t issue_volume;                                                       // 发行总量(单位:亿;类型:Qty10)      
    int64_t circulation_volume;                                                 // 流通总量(单位:亿;类型:Qty10)      
    int64_t principal_price;                                                    // 每百元本金额(单位:元;类型:Price6)
    ...
    int64_t base_rate_spread;                                                   // 基本利差(单位:%)(类型:Rate6)     
    ...
    int64_t current_interest_rate;                                              // 当前利率(单位:%)(类型:Rate6)     
    int64_t issue_price;                                                        // 发行价(单位:元;类型:Amt10)         
...
struct MDPreIssuedBondInfo
{
    ...
    char	security_code[ConstField::kRDISecurityCodeLen];                     // 债券代码                     
    char	symbol[ConstField::kSymLen];                                        // 债券名称                     
    int64_t	planned_circulation_volume;                                         // 计划发行量(单位:亿;类型:Qty10)            
    int64_t	actual_circulation_volume;                                          // 实际发行量(单位:亿;类型:Qty10)               
    int64_t	face_value;                                                         // 面值(单位:元;类型:Amt5)                  
    int64_t	starting_price;                                                     // 首发价格(单位:元;类型:Price6)
    ...
    int64_t	total_net_sell_limit;                                               // 净卖出总限额(单位:%;类型:Amt5)             
...
struct MDPreIPOBondInfo
{
    ...
    int64_t	coupon_rate;                                                        // 票面利率(类型:Rate6)     
...
struct PledgedConvertItem
{
    ...
    int64_t convert_rate;                                                       // 折算率(类型:Rate6)
};
...
struct MDSwapFixedFloatInfo
{
    ...
    int64_t	float_default_spread;                                           // 默认利差(单位BPs;类型:Amt5)
