#ifndef TI_AX_QUOTE_CLIENT_H
#define TI_AX_QUOTE_CLIENT_H
...
public:
    TiAxQuoteClient(std::string configPath, TiQuoteCallback* userCb);
    virtual ~TiAxQuoteClient();
