...
IaETFWorkerRedemptionEtf::IaETFWorkerRedemptionEtf(int64_t id, TiTraderClient* client, IaEtfQuoteDataCache* m_quote_cache, IaEtfSignalFactorPtr factor, std::string account)
