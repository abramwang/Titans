#ifndef __OC_TRADER_COMMANDER_GT_H__
#define __OC_TRADER_COMMANDER_GT_H__
#include <string>
#include <list>
#include <mutex>
...
public:
	OcTraderCommanderGt(uv_loop_s* loop, std::string configPath);
	virtual ~OcTraderCommanderGt();
