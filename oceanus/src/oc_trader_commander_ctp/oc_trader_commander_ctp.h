#ifndef __OC_TRADER_COMMANDER_CTP_H__
#define __OC_TRADER_COMMANDER_CTP_H__
#include <string>
#include <list>
#include <mutex>
...
public:
	OcTraderCommanderCtp(uv_loop_s* loop, std::string configPath);
	virtual ~OcTraderCommanderCtp();
